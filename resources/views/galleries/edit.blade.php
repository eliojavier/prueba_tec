...
@section('content')
    <div class="row">
        <div class="col-md-4">
            ...
            {!! Form::model($gallery, ['method' => 'PATCH','route' => ['admin.galleries.update',$gallery], 'id' => 'edit-gallery-form']) !!}
                @include('galleries.partials._form',[ 'submitButtonText' => 'Editar Gallería'])
            {!! Form::close() !!}
        </div>
        <div class="col-md-8">
            <h2>Aregar Fotos</h2>
            {!! Form::open(['route' => ['admin.galleries.photo',$gallery], 'id' => 'photos-form', 'class' => 'dropzone', 'files' => true]) !!}
            ...
            <div class="col-md-12 text-right">
                <a href="{{route('admin.galleries.show',$gallery)}}" class="bt bt-link">Ver más >></a>
            </div>
        </div>
